  ...
  const candidates = [
    {
      ...
      A_action: "å°†Alpha Researché¡¹ç›®æ‹†åˆ†ä¸ºä¸¤æ®µï¼Œç”¨VADERç”Ÿæˆcompound sentiment scoresï¼Œå†å†™MACDä¸ŽNLPçš„ç»“åˆã€‚",
    ...
    },
    {
      ...
      adviceScope: "resume_edit",
      adviceIntent: "experience_evidence",
      actionSummary: "æŒ‘é€‰ä¸€æ®µæœ€ç›¸å…³ç»åŽ†ï¼ŒæŠŠ bullet æ”¹æˆä»»åŠ¡ã€�æ–¹æ³•å’Œç»“æžœä¸‰éƒ¨åˆ†ã€‚",
