...
Generated: 2026-06-02T22:36:43.231Z
...
- product_manager (other, positions=8): top=12, flags=1, buried=5
- sales_customer_success (marketing_sales, positions=8): top=12, flags=11, buried=5
- sustainability_environment (legal_policy, positions=8): top=12, flags=12, buried=0
...
- communications_pr (marketing_sales, positions=6): top=12, flags=8, buried=5
- it_support (tech, positions=6): top=12, flags=12, buried=4
- research_academic (education_research, positions=6): top=12, flags=0, buried=5
- business_operations (business_ops, positions=3): top=12, flags=12, buried=1
- hospitality_events (business_ops, positions=3): top=12, flags=12, buried=5
- hr_recruiting (business_ops, positions=3): top=12, flags=12, buried=1
- journalism_media (media, positions=3): top=12, flags=12, buried=0
- actuarial (finance_accounting, positions=2): top=12, flags=11, buried=3
- education (education_research, positions=2): top=12, flags=2, buried=5
- other (other, positions=2): top=12, flags=11, buried=5
- social_services (healthcare_life_sciences, positions=2): top=12, flags=12, buried=0
- civil_construction (engineering_hardware, positions=1): top=12, flags=12, buried=0
- procurement (business_ops, positions=1): top=12, flags=12, buried=5
...
Keywords: Account Executive, Account Manager, Business Development, Business Development Analyst, sales customer success

### Flagged Current Top Rows
- #1 seg_19951 [no_role_signal] role=universal target=universal
  - title: 求职者的实习经历仅体现了财务记账和账单处理能力，未挖掘其中涉及客户信用评估（credit worthiness）和坏账风险管理的相关经验
  - action: 在accounts receivable相关的bullet point中，补充描述对客户信用状况的评估行为，例如审查客户的信用记录、处理chargeback及insufficient fund情况，体现'know your customer'及信用风险识别能力，以匹配credit risk相关岗位要求。
- #2 seg_25938 [no_role_signal] role=universal target=universal
  - title: 求职者将GPA单独占一行，浪费宝贵版面空间，导致无法放置更有价值的内容
  - action: 将GPA合并到教育背景同一行（如：Accumulate GPA 3.7），节省一行版面，用于补充更有意义的项目经历或关键词内容
- #3 seg_9077 [no_role_signal] role=universal target=universal
  - title: 求职者简历中复合词（如'world-building'）的连字符使用不确定，若拼写或格式有误会影响专业观感，且可能影响ATS关键词匹配。
  - action: 逐一核查简历中所有复合专业术语的标准写法，例如确认'world-building'是否需要连字符，确保与行业通用写法一致，避免因拼写错误被HR或ATS扣分。
...
- #6 seg_7487 [no_role_signal] role=universal target=universal
  - title: 求职者的案例研究经历仅列出研究内容，未清晰呈现每个case的核心产出和目的，HR无法判断研究的实际价值和商业影响力。
  - action: 将每个case study改写为独立的summary bullet point，结构为：研究对象/场景 + 分析内容（如PR管理、竞争分析、宏观影响）+ 目的/价值（帮助客户规避风险或理解竞争环境），确保每条bullet都能独立传递信息量。
- #7 seg_11739 [no_role_signal] role=universal target=universal
...
- #8 seg_21665 [no_role_signal] role=universal target=universal
  - title: 求职者倾向于只投纯金融买方/卖方岗位，忽略了保险资管等具有相关性的岗位，而自身已有相关工作经验，理应拓宽投递范围。
  - action: 在保持核心目标岗位的同时，将保险资管、liability driven investment等相关机构纳入投递范围，充分利用已有的relevant working experience提升录取概率。

### Buried Candidate Rows
- id=6661 score=10 role=marketing target=universal tags=weak_target_role_alignment,low_role_specificity,missing_exact_job_title
  - title: 求职者不知道如何用关键词搜索Marketing相关岗位
  - action: 用以下关键词搜索Marketing类岗位：marketing specialist、marketing coordinator、digital marketing、campaign、social media、account manager、account specialist、business development；根据偏好区分纯销售岗（sales representative、BD）与客户管理岗（account manager）及纯营销岗（digital marketing、campaign）。
- id=20758 score=10 role=software_engineer,marketing,data_analyst target=data_analyst tags=low_soft_skill_match
  - title: 求职者将业务开发、网站建设、客户服务等多项职责混写...
  - action: 将现有的混合描述拆分为独立的bullet point：1）business development（展会+email campaign获客）；2）website establishment及product listing优化（enhance product listing to improve searchability）；3）客户服务/account executive（order status tracking、customer communication）。
...
- id=4068 score=7 role=data_analyst target=universal tags=missing_linkedin
  - title: 求职者对Solution Engineer/Sol...
  - action: 使用ChatGPT查询「What are the synonyms of solution architect or solution engineer?」，整理出所有相关职位名称，在LinkedIn/Indeed等平台用不同关键词搜索，扩大投递范围。
- id=6199 score=7 role=data_analyst target=data_analyst tags=low_hard_skill_match,low_soft_skill_match,keywords_only_in_skills
...
Target: Climate  Analyst
Keywords: Climate  Analyst, Climate  Specialist, Climate Analyst, Climate Specialist, sustainability environment
...
Keywords: Communication, Communication Associate, Corporate Communications Manager, Public Relations, communications pr
...
### Buried Candidate Rows
- id=690 score=7 role=data_analyst target=data_analyst tags=low_soft_skill_match,low_jd_keyword_match
  - title: 不要一份简历投所有岗位
  - action: 1）收集目标每个方向的10个JD；2）用在线JD-resume关键词匹配工具找出缺失关键词；3）在对应版本简历的经历描述中补充这些词；4）特别注意collaboration/communication等软技能关键词同样需要体现
- id=1498 score=7 role=data_analyst target=data_analyst tags=low_hard_skill_match,low_soft_skill_match,education_details_missing
  - title: 求职者将学校咨询课程项目（含真实客户、presen...
  - action: 将学校consulting project加回简历的project experience区，重点体现collaboration、communication、presentation、problem solving等软技能关键词，即使该项目不直接涉及数据分析。
- id=1544 score=7 role=data_analyst,marketing target=universal tags=low_soft_skill_match
  - title: 学生医药实习内容偏专业术语
  - action: 将该实习改写为4个bullet point：①Tableau/Power BI数据可视化；②linear regression预测药品销售趋势；③feature analysis识别影响销量的关键因素（地理位置等）；④参加行业seminar，与pharma同行交流best practices，体现communication能力。
- id=1640 score=7 role=software_engineer target=software_engineer,software_development_engineer tags=low_soft_skill_match,weak_result_orientation,weak_action_verbs,low_measurable_results
  - title: 许多求职者只在简历上展示技术能力
  - action: 在整篇简历中至少有1-2个bullet point专门体现跨团队协作方式，例如与哪些部门合作、如何推动沟通、如何协调资源，每个工作经历和项目经历中都应有体现。
- id=2628 score=7 role=product_manager,data_analyst target=data_analyst tags=low_soft_skill_match,education_details_missing
  - title: 求职者将技术标准转化为视频脚本、教育材料的经历描述模糊
  - action: 将该经历改写为：将技术标准转化为面向企业运营商的定制化视频脚本及教育简报，推动best practice合规落地；建议放在项目描述第二条，并补充受众规模或覆盖数量等量化数据。

## it_support
Target: Information Systems Manager
Keywords: Information Systems Manager, It Analyst, It Manager, IT Specialist, it support

### Flagged Current Top Rows
- #1 seg_19951 [no_role_signal, conflict:portfolio] role=universal target=universal
  - title: 求职者的实习经历仅体现了财务记账和账单处理能力，未挖掘其中涉及客户信用评估（credit worthiness）和坏账风险管理的相关经验
  - action: 在accounts receivable相关的bullet point中，补充描述对客户信用状况的评估行为，例如审查客户的信用记录、处理chargeback及insufficient fund情况，体现'know your customer'及信用风险识别能力，以匹配credit risk相关岗位要求。
- #2 seg_25938 [no_role_signal] role=universal target=universal
  - title: 求职者将GPA单独占一行，浪费宝贵版面空间，导致无法放置更有价值的内容
...
- #3 seg_9077 [no_role_signal] role=universal target=universal
  - title: 求职者简历中复合词（如'world-building'）的连字符使用不确定，若拼写或格式有误会影响专业观感，且可能影响ATS关键词匹配。
  - action: 逐一核查简历中所有复合专业术语的标准写法，例如确认'world-building'是否需要连字符，确保与行业通用写法一致，避免因拼写错误被HR或ATS扣分。
- #4 seg_19340 [no_role_signal] role=universal target=universal
...
- #5 seg_7872 [no_role_signal, conflict:hardware] role=universal target=universal
...
- #6 seg_17880 [no_role_signal] role=universal target=universal
  - title: 求职者简历在完成细节填写后仍存在内容冗余问题：部分bullet point重复传递相同信息，同时某些条目（如在线项目）放错位置，未能发挥最大效果。
  - action: 完成当前逐条删减与补写后，进行第二轮整体筛选：（1）识别并删除重复条目；（2）评估是否将某些在线项目内容移至project栏目下展示；（3）以HR视角判断哪些内容读一遍已足够、无需重复出现。
- #7 seg_4438 [no_role_signal] role=universal target=universal
  - title: 求职者简历内容分散、不够紧凑，且未针对ATS机器筛选优化，导致通过率低
  - action: 将简历压缩至一页，删除冗余内容（如学生会经历、操作系统列表等），重组结构为education、technical project and internship、relevant technical skills，提升ATS关键词密度
- #8 seg_7487 [no_role_signal, conflict:portfolio] role=universal target=universal
  - title: 求职者的案例研究经历仅列出研究内容，未清晰呈现每个case的核心产出和目的，HR无法判断研究的实际价值和商业影响力。
  - action: 将每个case study改写为独立的summary bullet point，结构为：研究对象/场景 + 分析内容（如PR管理、竞争分析、宏观影响）+ 目的/价值（帮助客户规避风险或理解竞争环境），确保每条bullet都能独立传递信息量。

### Buried Candidate Rows
- id=10416 score=7 role=software_engineer,data_analyst target=data_analyst tags=weak_result_orientation,weak_action_verbs,low_measurable_results
  - title: 求职者描述了为公司开发Web UI上传系统的项目
  - action: 将项目成果改写为具体量化数字，例如：将原来IT Manager需花费5小时完成的数据上传工作缩短至15分钟，效率提升约20倍（95%时间节省），并结合涉及的数据记录数量一并呈现。
- id=17515 score=7 role=marketing target=universal tags=low_role_specificity,weak_target_role_alignment,missing_exact_job_title
  - title: 求职者目前只考虑PE方向
  - action: 在申请PE职位的同时，将Private Credit Manager纳入目标岗位列表，调研两类岗位的技能重叠点（如信用分析、财务建模），并针对性调整简历侧重点。
- id=20731 score=7 role=product_manager target=universal tags=weak_target_role_alignment,low_role_specificity,missing_exact_job_title
  - title: 求职者有内审相关实习经历（协助内年终内审、盘点产品...
  - action: 梳理已有实习经历中的核心任务，识别与目标岗位的匹配度，主动补充申请与实习内容直接对应的岗位（如有内审经历则申请internal audit analyst）
- id=20733 score=7 role=product_manager target=universal tags=weak_target_role_alignment,low_role_specificity,missing_exact_job_title,weak_action_verbs
  - title: 求职者有会计实习经历（参与内审流程）
  - action: 将internal audit analyst加入目标申请岗位列表，结合已有的内审实习经历（协助各部门内审、核查产品损耗、进出库系统操作）重点包装相关简历内容。
...
Keywords: Business Manager, Management Trainee, Sport Management, business operations
...
### Buried Candidate Rows
- id=7147 score=7 role=product_manager,software_engineer target=product_manager tags=weak_target_role_alignment,low_role_specificity,missing_exact_job_title,education_details_missing
  - title: 求职者同时对苹果Hardware和Operatio...
  - action: 明确目标岗位所在部门的典型职位类型，点进具体岗位页面查看关键词和职责描述，根据自身背景（商学院学生或工程背景）选择匹配度更高的方向，避免盲目投递不符合专业背景的职位。

## hospitality_events
Target: Event Planner
Keywords: Event Planner, Host, Hotel Management/Hospitality, hospitality events
...
### Buried Candidate Rows
- id=362 score=7 role=software_engineer,product_manager target=frontend_engineer,full_stack_engineer,software_engineer,software_development_engineer tags=weak_result_orientation,weak_action_verbs,low_measurable_results,weak_experience_keyword_evidence,vague_project_details
  - title: 学生只写了开发功能
  - action: 项目bullet的最后一行应写misc内容（deployment、测试、文档等）：包括将APP从localhost部署到云平台（AWS/GCP等）、数据收集、CI/CD等
...
- id=4491 score=7 role=software_engineer,data_analyst target=data_analyst tags=low_hard_skill_match,keywords_only_in_skills,weak_experience_keyword_evidence,weak_result_orientation
  - title: 求职者在描述项目时只说"join所有的表"
  - action: 在简历或面试描述项目时，将SQL操作具体化：说明join了哪张表（如users表）、目的是获取什么信息（如guest/host的国籍等个人信息），以及为何需要做两次join（因user_id既可指guest也可指host）。
- id=5028 score=7 role=software_engineer,data_analyst target=universal tags=weak_result_orientation,weak_action_verbs,low_measurable_results,weak_experience_keyword_evidence
  - title: 求职者因项目仅在localhost运行、未正式上线...
  - action: 若项目有部署能力或曾尝试部署（即使未完成线上访问），可在bullet point中写入deploy相关描述；Junit test同理，只要有相关实践均可写入
- id=5401 score=7 role=data_analyst target=data_analyst tags=low_soft_skill_match,weak_action_verbs
  - title: 求职者项目经历中缺少体现团队协作管理的具体动词
  - action: 在简历bullet point中加入'Assigning tasks across the team'、'Conducting regular check-ups with teammates to ensure timeline'等动词短语，将参与管理改写为主动主持（hosting）的形式

## hr_recruiting
Target: Full-Cycle Recruiter
Keywords: Full-Cycle Recruiter, Human Resources, Human Resources Specialist, hr recruiting
...
### Buried Candidate Rows
- id=21518 score=7 role=software_engineer,data_analyst target=universal tags=weak_experience_keyword_evidence,weak_result_orientation,vague_project_details
  - title: 求职者简历中的项目名称不够正式
  - action: 将项目名称改写为正式英文名称（如 Investment Platform 或 VC Venture Capital Platform）；在项目描述中列举平台所提供的具体数据类型，包括 revenue data、human resources data、attrition data、客户留存率等，使描述更具体有说服力。

## journalism_media
Target: Data Journalist
Keywords: Data Journalist, Journalist, Music Production Assistant, journalism media
...
Keywords: Actuarial Analyst, Actuary, actuarial
...
- #3 seg_25938 [no_role_signal] role=universal target=universal
  - title: 求职者将GPA单独占一行，浪费宝贵版面空间，导致无法放置更有价值的内容
  - action: 将GPA合并到教育背景同一行（如：Accumulate GPA 3.7），节省一行版面，用于补充更有意义的项目经历或关键词内容
- #4 seg_9077 [no_role_signal] role=universal target=universal
  - title: 求职者简历中复合词（如'world-building'）的连字符使用不确定，若拼写或格式有误会影响专业观感，且可能影响ATS关键词匹配。
  - action: 逐一核查简历中所有复合专业术语的标准写法，例如确认'world-building'是否需要连字符，确保与行业通用写法一致，避免因拼写错误被HR或ATS扣分。
...
### Buried Candidate Rows
- id=881 score=7 role=machine_learning target=data_analyst tags=weak_summary_role_alignment,weak_target_role_alignment,low_role_specificity,missing_exact_job_title,formatting_penalty_triggered
  - title: 候选人简历缺少清晰的objective statement
  - action: 在简历顶部加入objective statement，明确表达你是做data science和actuarial science结合的方向
- id=1063 score=7 role=machine_learning,data_analyst target=data_analyst tags=weak_summary_role_alignment
  - title: 不要一份简历投所有岗位
...
- id=1395 score=7 role=data_analyst target=data_analyst tags=low_jd_keyword_match,missing_priority_keywords,resume_not_tailored_to_jd,weak_result_orientation,weak_action_verbs,low_measurable_results
  - title: 现有简历项目描述关键词偏精算写法
  - action: 参考目标数据分析JD，在项目标题中加入'data'关键词（如'actuarial/data pricing project'）；量化数据处理规模（如5000+数据点）；将精算关键词小幅替换为数据分析语境词汇。
...
## other
Target: All Students
Keywords: All Students, Other, other
...
### Buried Candidate Rows
- id=1005 score=10 role=data_analyst target=data_analyst tags=keywords_only_in_skills
  - title: 求职者用于投DA岗位的简历缺乏DA必备关键词（SQ...
  - action: 在DA简历的实习经历中明确体现SQL、Python、Excel、Tableau或Power BI、跨部门协作（works with other functions）这五类关键词，优先出现在工作经历bullet point中。
- id=1660 score=10 role=data_analyst target=data_analyst tags=low_hard_skill_match,keywords_only_in_skills
  - title: 求职者用DS导向的简历去申请DA岗位
  - action: 在DA简历的实习经历中必须体现：SQL、Python、Excel、Tableau或Power BI、跨部门合作（works with other functions）这五类关键词。
- id=4822 score=10 role=data_analyst target=data_analyst tags=generic_resume_positioning,resume_not_tailored_to_jd,low_role_specificity,weak_target_role_alignment,formatting_penalty_triggered
  - title: 不要一份简历投所有岗位
  - action: 将与目标岗位相关性低的经历单独归入"Project and Other Experience"板块，避免占据核心经历区域，保持简历主体聚焦在数据分析相关内容上。
- id=4824 score=10 role=marketing,data_analyst target=data_analyst tags=weak_result_orientation,weak_action_verbs,low_measurable_results,weak_target_role_alignment
  - title: 求职者将与目标岗位无关的个人经历（如电竞获奖）放在...
  - action: 根据目标岗位筛选简历内容：数据岗不需要电竞、游戏相关经历；若目标为咨询公司且有marketing/非数据相关经历，可合并归类为'Project and Other Experience'板块，而非单独占用大量篇幅。
- id=6110 score=10 role=software_engineer target=universal tags=weak_experience_keyword_evidence,weak_result_orientation,vague_project_details
  - title: 求职者简历中存在与目标岗位不太相关的项目
  - action: 将不相关项目合并为一个条目，使用'Other Projects'作为标题，列出论文/项目名称，配一句总结性标题即可，不需展开细节。

## social_services
Target: Psychologist
Keywords: Psychologist, Social Worker, social services
...
Keywords: Construction Manager, civil construction
...
Keywords: purchasing agent, procurement

### Flagged Current Top Rows
- #1 seg_19951 [no_role_signal] role=universal target=universal
  - title: 求职者的实习经历仅体现了财务记账和账单处理能力，未挖掘其中涉及客户信用评估（credit worthiness）和坏账风险管理的相关经验
  - action: 在accounts receivable相关的bullet point中，补充描述对客户信用状况的评估行为，例如审查客户的信用记录、处理chargeback及insufficient fund情况，体现'know your customer'及信用风险识别能力，以匹配credit risk相关岗位要求。
- #2 seg_2527 [role_mismatch] role=supply_chain target=supply_chain_analyst,procurement,logistics
  - title: 求职者同时对procurement和logistic两个方向有兴趣，若用同一份简历投递所有职位，无法做到关键词和内容的精准匹配，降低通过率。
  - action: 准备两份定制简历：一份针对procurement岗位，调整Title和bullet point内容以突出采购相关经验；另一份针对logistic岗位，相应调整Title与内容。申请对应方向时分别使用。
- #3 seg_25938 [no_role_signal] role=universal target=universal
  - title: 求职者将GPA单独占一行，浪费宝贵版面空间，导致无法放置更有价值的内容
  - action: 将GPA合并到教育背景同一行（如：Accumulate GPA 3.7），节省一行版面，用于补充更有意义的项目经历或关键词内容
- #4 seg_9077 [no_role_signal] role=universal target=universal
...
### Buried Candidate Rows
- id=2524 score=12 role=supply_chain target=supply_chain_analyst,procurement,logistics tags=weak_result_orientation,weak_action_verbs,low_measurable_results,weak_target_role_alignment,missing_exact_job_title
  - title: 求职者担心将简历职位头衔从实际公司给的title改...
  - action: 将职位头衔调整为更贴合目标岗位的名称（如从coordinator改为specialist或senior specialist），若被问及差异可解释为公司内部系统未更新，重点是先通过简历筛选获得面试机会，不要因为title问题而错失进入行业的敲门砖。
- id=2525 score=12 role=supply_chain target=supply_chain_analyst,procurement,logistics tags=generic_resume_positioning,low_role_specificity
  - title: 不要一份简历投所有岗位
  - action: 为procurement和logistics分别制作一份定制化简历，针对不同岗位调整职位title和工作内容描述，用对应简历投递对应方向的职位，保持每份简历的专一性和针对性。
- id=2526 score=12 role=supply_chain target=supply_chain_analyst,procurement,logistics tags=weak_result_orientation,weak_action_verbs,low_measurable_results,weak_target_role_alignment,education_details_missing,missing_exact_job_title
  - title: 求职者实际职位Title与简历所写不完全一致
  - action: 将简历中的职位Title修改为更贴合求职方向（procurement/logistic）的具体Title，并准备好合理解释（如国内系统未及时更新），以便在背景调查阶段说明。
- id=2528 score=12 role=supply_chain target=supply_chain_analyst,procurement,logistics tags=weak_summary_role_alignment,low_role_specificity,weak_target_role_alignment,low_jd_keyword_match,missing_priority_keywords,resume_not_tailored_to_jd
  - title: 求职者简历标题看起来像sales
  - action: 将简历中的职位title及相关描述改写为突出procurement职能的关键词，使简历一眼看去符合procurement岗位要求，从而吸引对口招聘方。
- id=2533 score=12 role=supply_chain target=supply_chain_analyst,procurement,logistics tags=weak_action_verbs
  - title: 求职者描述工作成果时只写定性结论（如"提升了交付率"）
  - action: 在简历和面试回答中，将所有成果改写为量化表达，例如"供应商准时交付率提升X%"或"库存成本降低Y%"，即使数字是估算也要给出具体数字，让表述有头有尾。