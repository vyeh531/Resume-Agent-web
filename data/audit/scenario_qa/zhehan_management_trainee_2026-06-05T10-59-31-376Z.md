...
- action: 将零散的小项目合并为一个或少数几个大项目呈现；删除与目标岗位关联度低或不够data-driven的项目；尝试将相关项目串联成一个完整故事线，丰富细节描述。
- mentor: 简历中Work Experience和Project通常不需要分开列，合并呈现更紧凑；项目描述过于简短（仅一个bullet）会让HR觉得经历不足，应适当扩展或整合。
- HR: 一段经历要让我看出你承担了什么价值，否则很容易被当成普通参与者。
